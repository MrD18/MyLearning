package com.yss.java8.项目中使用Lambda进行重构.dao.impl;


import com.yss.java8.项目中使用Lambda进行重构.dao.BaseDAO;
import com.yss.java8.项目中使用Lambda进行重构.dao.IStrategy;
import com.yss.java8.项目中使用Lambda进行重构.dao.mapper.DeptMapper;
